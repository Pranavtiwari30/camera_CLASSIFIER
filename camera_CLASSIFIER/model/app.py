...
class App:
    ...
    def init_gui(self):
        ...
        self.classname_one = simpledialog.askstring("Classname One", "Enter the name of first class:", parent=self.window)
        self.classname_two = simpledialog.askstring("Classname Two", "Enter the name of second class:", parent=self.window)
        ...
        def save_for_class(self, class_num):
            ...
            def reset(self):
                for diectory in ['1', '2']:
                    for file in os.listdir(directoy):
                ...
                self.class_label.config(test='CLASS')
            def update(self):
                ...
                self.window.after(self.dealy, self.update)                     